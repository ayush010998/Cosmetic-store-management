...
if(isset($_POST['confirm_order']))
{
   ...
   $sql2="SELECT order_id FROM order_total WHERE customer_id='$cid' ORDER BY order_date DESC";
   ...
   if(!empty($_SESSION["shopping_cart"]))
   {
       foreach($_SESSION["shopping_cart"] as $item)
       {
        ...
        $oid=mysqli_real_escape_string($conn,$order_id);
        $itid=$item['item_id'];
        $quan=$item['item_quantity'];
        $price=$item['item_price'];
         $sql1="INSERT INTO order_detail(order_id,pid,quantity,subtotal) VALUES ($oid,'$itid',$quan,$price)";
...
?>
      ...
      <form action="demo.php?tid=<?php echo $total; ?>" method="POST">
